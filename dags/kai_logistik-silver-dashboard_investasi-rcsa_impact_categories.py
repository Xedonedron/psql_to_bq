...
def build_query_and_run(**kwargs):
    ...
    query = f"""
        ...
        SELECT
            ...
            CAST(name_taxonomy_id as INTEGER) as name_taxonomy_id,
            CAST(name_sub_taxonomy_id as INTEGER) as name_sub_taxonomy_id,
...
with models.DAG(
    'dashboard_investasi-rcsa_impact_categories',
    ...
    dump_from_postgres_to_gcs = PostgresToGCSOperator(
        ...
        SELECT
            ...
            "name_taxonomy_id"::BIGINT as "name_taxonomy_id",
            "name_sub_taxonomy_id"::BIGINT as "name_sub_taxonomy_id",
