...
TABLE = 'mard'
ALTER_TABLE = 'storage_location_data_for_material'
GCS_BUCKET = 'kai_sap'
...
def build_query_and_run(**kwargs):
    ...
    query = f"""
        INSERT INTO {PROJECT_ID}.{SCHEMA}.{ALTER_TABLE} (material_number, plant, storage_location, unrestricted_stock, last_update_date_time, last_insert_to_bigquery)
        SELECT
            MATNR as material_number,
            WERKS as plant,
            LGORT as storage_location,
            CAST(LABST as NUMERIC) as unrestricted_stock,
