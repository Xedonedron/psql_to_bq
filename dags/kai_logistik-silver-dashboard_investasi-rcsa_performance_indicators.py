...
TABLE = 'rcsa_performance_indicators'
...
def build_query_and_run(**kwargs):
    ...
    query = f"""
        ...
        SELECT
            ...
            CAST(indicator_corporate_id as INTEGER) as indicator_corporate_id,
            CAST(indicator_unit_id as INTEGER) as indicator_unit_id,
...
with models.DAG(
    'dashboard_investasi-rcsa_performance_indicators',
    ...
    dump_from_postgres_to_gcs = PostgresToGCSOperator(
        ...
        SELECT
            ...
            "indicator_corporate_id"::BIGINT as "indicator_corporate_id",
            "indicator_unit_id"::BIGINT as "indicator_unit_id",
