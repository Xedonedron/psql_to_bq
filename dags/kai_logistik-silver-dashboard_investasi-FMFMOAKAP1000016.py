...
def build_query_and_run(**kwargs):
    ...
    query = f"""
        ...
        SELECT
            ...
            CAST(SOUR1_FROM as STRING) as SOUR1_FROM,
            CAST(SOUR1_TO as STRING) as SOUR1_TO,
            CAST(VALID_FROM as STRING) as VALID_FROM,
            CAST(TARGET1 as STRING) as TARGET1,
            CAST(DELETE_FLG as STRING) as DELETE_FLG,
            CAST(ADDED_BY as STRING) as ADDED_BY,
            CAST(ADDED_ON as STRING) as ADDED_ON,
...
with models.DAG(
    'dashboard_investasi-FMFMOAKAP1000016',
    ...
    dump_from_postgres_to_gcs = PostgresToGCSOperator(
        ...
        SELECT
            "MANDT"::TEXT as "MANDT",
            "SOUR1_FROM"::TEXT as "SOUR1_FROM",
            "SOUR1_TO"::TEXT as "SOUR1_TO",
            "VALID_FROM"::TEXT as "VALID_FROM",
            "TARGET1"::TEXT as "TARGET1",
            "DELETE_FLG"::TEXT as "DELETE_FLG",
            "ADDED_BY"::TEXT as "ADDED_BY",
            "ADDED_ON"::TEXT as "ADDED_ON",
