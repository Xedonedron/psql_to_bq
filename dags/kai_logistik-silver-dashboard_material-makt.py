...
TABLE = 'makt'
ALTER_TABLE = "material_descriptions"
...
def build_query_and_run(**kwargs):
    ...
    query = f"""
        INSERT INTO {PROJECT_ID}.{SCHEMA}.{ALTER_TABLE} (client, material_numer, language_key, material_description_short_text, material_description_long_text, last_update_date_time, last_insert_to_bigquery)
        SELECT
            mandt as client,
            matnr as material_numer,
            spras as language_key,
            maktx as material_description_short_text,
            maktg as material_description_long_text,
