...
def build_query_and_run(**kwargs):
    ...
    query = f"""
        ...
        SELECT
            ...
            CAST(investasi as STRING) as investasi,
            CAST(klasifikasi_pekerjaan as STRING) as klasifikasi_pekerjaan,
            CAST(kategori as STRING) as kategori,
            CAST(nilai_rka as NUMERIC) as nilai_rka,
...
with models.DAG(
    'dashboard_investasi-program_status',
    ...
    dump_from_postgres_to_gcs = PostgresToGCSOperator(
        ...
        SELECT
            ...
            "investasi"::TEXT as "investasi",
            "klasifikasi_pekerjaan"::TEXT as "klasifikasi_pekerjaan",
            "kategori"::TEXT as "kategori",
            "nilai_rka"::NUMERIC as "nilai_rka",
