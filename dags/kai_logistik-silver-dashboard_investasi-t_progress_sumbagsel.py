...
def build_query_and_run(**kwargs):
    ...
    query = f"""
        ...
        SELECT
            ...
            CAST(amount_progress as NUMERIC) AS amount_progress,
...
with models.DAG(
    'dashboard_investasi-t_progress_sumbagsel',
    ...
    dump_from_postgres_to_gcs = PostgresToGCSOperator(
        ...
        SELECT
            ...
            "amount_progress"::DOUBLE PRECISION as "amount_progress"
        FROM {SCHEMA}."{TABLE}";
        """,
        bucket=GCS_BUCKET,
