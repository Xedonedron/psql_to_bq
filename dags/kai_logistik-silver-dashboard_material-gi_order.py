...
def build_query_and_run(**kwargs):
    ...
    query = f"""
        ...
        SELECT
            ...
            CAST (MAKTG AS STRING) AS MAKTG,
            CAST (WERKS AS STRING) AS WERKS,
            CAST (MJAHR AS STRING) AS MJAHR,
            CAST (BULAN AS INTEGER) AS BULAN,
            CAST (CNT_ISSUE AS INTEGER) AS CNT_ISSUE,
            CAST (JML_ISSUE AS NUMERIC) AS JML_ISSUE,
...
with models.DAG(
    ...
    dump_from_postgres_to_gcs = PostgresToGCSOperator(
        ...
        SELECT
            ...
            "CNT_ISSUE"::INTEGER as "CNT_ISSUE",
            "JML_ISSUE"::NUMERIC as "JML_ISSUE",
