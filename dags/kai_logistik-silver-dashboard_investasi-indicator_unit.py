...
def build_query_and_run(**kwargs):
    ...
    query = f"""
        ...
        SELECT
            ...
            CAST(directorat_id as INTEGER) AS directorat_id,
            CAST(directorat as STRING) AS directorat,
...
with models.DAG(
    'dashboard_investasi-indicator_unit',
    ...
    dump_from_postgres_to_gcs = PostgresToGCSOperator(
        ...
        SELECT
            "id"::BIGINT as "id",
            "code"::TEXT as "code",
            "directorat_id"::INTEGER as "directorat_id",
            "directorat"::TEXT as "directorat",
            "unit_id"::INTEGER as "unit_id",
            "period_id"::INTEGER as "period_id",
            "unit"::TEXT as "unit",
